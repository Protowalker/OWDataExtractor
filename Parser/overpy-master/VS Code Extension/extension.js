...
<body>
    <div id="wrapper">
        ...
        <p>If you have an error, you will need to reload the page.</p>
        <textarea id="decompiler-input-text" placeholder="Copy paste your workshop code here.&#10;&#10;Note: the decompiler only supports code copied directly from Overwatch.&#10;&#10;If you wish to decompile code generated by a third-party tool (including OverPy), paste it into Overwatch and copy it."></textarea>
        <br>
